...
def user_signup_complete():
    ...
    if not username_error and not password_error and not password_validate_error and not email_error:
        ...
        return render_template('user_form.html', username_error=username_error, username=username, password_error=password_error, password=password, password_validate_error=password_validate_error, password_validate=password_validate, email_error=email_error, email=email)
